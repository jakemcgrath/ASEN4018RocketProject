...
% addpath(fullfile('C:\Users\grant\Documents\MATLAB\ASEN_4013\Code\ASEN4018RocketProject\MatlabCEA'));
addpath('MatlabCEA')
addpath('MatlabTools')
...
while rb < (r_grain_o - r_grain_i) && rb < h_grain % while there is unburned grain remaining
    ...
    delta_Vol = A_burn; % [m^3/s] rate of change in burn cavity volume 
